...
/**
 * This class serves to locate and alter the orientation of objects based on the
 * proximity of other sprites.
 * <p>
 * This class uses a comparator to query available sprites on the level and
 * located the nearest one.
 *
 * @author Timko
 *
 */
public class EnemyTracker {
    ...
    /**
     * Locate the distance of the closest sprite using a comparator based on
     * manhattan distance
     *
     * @param enemies
     *        sprites available on the level
     * @param myLocation
    ...
    protected double calculateOrientationToClosestEnemy (Coordinate myLocation,
    ...
    /**
     * Computes the angle between the orientation of the caller and where the
     * closest enemy is positioned
     *
     * @param myLocation
     *        Coordinate of caller position
     * @param enemyLocation
